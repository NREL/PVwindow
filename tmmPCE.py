...
from numericalunits import W, K, nm, m, cm, s, eV, meV, V, mA, c0, hPlanck, kB, e, C, A
...
print('solar_constant = ',solar_constant / (W/m**2))
...
j_values = np.array([current_density(x, 0.6,AbsInterp) for x in Vs])
plt.figure()
