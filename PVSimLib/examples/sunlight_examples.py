...
print('declination',radiation.declination(1))
print('Equation of time (min): ', radiation.equation_of_time(1))
print('Time Correction (min): ', radiation.time_correction(-3.71,140, 10))
print('Elevation, Azimuth (degrees): ', radiation.elev_azi(-23.0116367279, -34, 13.27))
print('Sun Azimuth and Elevation (degrees)', radiation.sun_position(1, -34, 140, 10, 14, 0))
print('Sunrise, Sunset (hours)', radiation.sun_rise_set(-34, -23.0116367279, -43.71))
print('Direct light on a module (fraction)', radiation.module_direct(94.7078, 36.9758, 0, 45))
